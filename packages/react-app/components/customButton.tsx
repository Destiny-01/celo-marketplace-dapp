...
export const CustomButton = (props: customProp) => {
                ...
                return (
                  <div style={{ display: 'flex', gap: 12 }}>
                    <button
                      ...
                      type="button"
                      className={`px-4 py-2 rounded-lg ${color} ${text} font-semibold`}
                    >
                      {chain.hasIcon && (
                        <div
                          style={{
                    ...
                    <button onClick={openAccountModal} type="button" className={`px-4 py-2 rounded-lg ${color} ${text} font-semibold`}>
                      {account.displayName}
                    </button>
                  </div>
                );
